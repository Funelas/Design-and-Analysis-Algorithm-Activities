...
product = f"{user_inputs[0] * user_inputs[1]:.2f}"
try:
    quotient = f"{(user_inputs[0] / user_inputs[1]):.2f}"
...
print(f"The quotient of {user_inputs[0]} and {user_inputs[1]} is equal to {quotient}.")
